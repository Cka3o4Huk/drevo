...
public class ComplexNode extends JCheckBox {
	...
	public static State NOT_SELECTED = new State();

	public static State SELECTED = new State();

	public static State DONT_CARE = new State();

	private String text;

	private final TristateDecorator model;

	public ComplexNode(String text, Icon icon, State initial) {
		super(text, icon);

		// Reset the keyboard action map
		/**
		 * ActionMap map = new ActionMapUIResource(); map.put("pressed", new
		 * AbstractAction() { public void actionPerformed(ActionEvent e) {
		 * grabFocus(); model.nextState(); } }); map.put("released", null);
	...
	public ComplexNode(String text, State initial) {
		this(text, null, initial);
	}

	public ComplexNode(String text) {
